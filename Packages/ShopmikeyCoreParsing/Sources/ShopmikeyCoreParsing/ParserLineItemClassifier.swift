//
//  ParserLineItemClassifier.swift
//  ShopmikeyCoreParsing
//

import Foundation
import ShopmikeyCoreModels

enum ParserLineItemClassifier {
    static func classify(
        description: String,
        partNumber: String? = nil,
        contextText: String? = nil
    ) -> (kind: POItemKind, confidence: Double, reasons: [String], suggestedPartNumber: String?, normalizedDescription: String) {
    ...
    // MARK: - Shared parsing rules

    private static let tentativeConfidenceThreshold: Double = 0.55

    private static let feeSignals: [String] = [
        "shipping",
        "freight",
        "shop-fee",
        "shop fee",
    ...
    private static let tireSignals: [String] = [
        "tire",
        "tyre",
        "run-flat",
        "run flat",
    ...
    private static let tireBrands: [String] = [
        "michelin",
        "bridgestone",
        "goodyear",
        "continental",
    ...
    private static let partSignals: [String] = [
        "part",
        "battery",
        "filter",
        "spark",
    ...
    private static let partPhraseSignals: [String] = [
        "cv axle",
        "clutch kit",
        "spark plug",
    ...
    private static func firstTireSize(in text: String) -> String? {
        let patterns = [
            #"\b\d{3}/\d{2,3}/\d{2}\b"#,
    ...
    private static func suggestedPartNumber(from description: String, explicitPartNumber: String?) -> String? {
